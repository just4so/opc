...
export function CommunityClaimDialog({
  communityId,
  communityName,
  children,
}: {
      ...
      <DialogContent className="sm:max-w-md">
        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full" disabled={submitting || !contactName.trim() || !contactInfo.trim()}>
              {submitting ? '提交中...' : '提交认领'}
            </Button>
          </form>
        )}
