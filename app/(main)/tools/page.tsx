  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-ink">OPC创业者工具箱</h1>
        <p className="mt-2 text-mute">按场景精选，标注国内可用性</p>
      </div>
...
function ToolCard({ tool }: { tool: Tool }) {
  return (
    <a
      ...
      className="block p-5 rounded-xl border border-hairline-soft bg-canvas card-hover transition-all"
    >
      ...
      <p className="text-sm text-mute mb-3">{tool.description}</p>
