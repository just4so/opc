  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="bg-canvas rounded-xl shadow-sm p-8 md:p-12">
          <p className="text-mute mb-8">最后更新日期：2026 年 5 月</p>

          <div className="space-y-8 text-mute">
            <section>
              <h2 className="text-xl font-semibold text-ink mb-4">概述</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-ink mb-4">信息收集</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-ink mb-4">信息使用</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-ink mb-4">信息共享</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-ink mb-4">数据安全</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-ink mb-4">您的权利</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-ink mb-4">Cookie 使用</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-ink mb-4">政策更新</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-ink mb-4">联系我们</h2>
              <p className="leading-relaxed">
                如果您对本隐私政策有任何疑问，请通过
